...
//
//     final cancelTicket = cancelTicketFromJson(jsonString);

import 'dart:convert';

CancelTicket cancelTicketFromJson(String str) =>
    CancelTicket.fromJson(json.decode(str));

String cancelTicketToJson(CancelTicket data) => json.encode(data.toJson());
