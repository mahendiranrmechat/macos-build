...
// Track which barcode index was copied
  int? copiedIndex;
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        // 🔹 Barcode Row with Copy Icon + Subtle Feedback
                                        SizedBox(
                                        ...
                                        Text(
                                            "Play Points: ${results[index].ticketPrice?.floor() ?? 0}"),
                                        Text(
                                            "Win Points: ${results[index].winPrice?.floor() ?? 0}"),
                                        Text(
                                            "Jackpot Win Points: ${results[index].jackpotPrice?.floor() ?? 0}"),
                                        Text(
                                            "Total Win Points: ${results[index].totalWinPrice?.floor() ?? 0}"),
                                        Text(
