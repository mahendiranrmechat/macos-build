...
class LottoTabView3D extends ConsumerStatefulWidget {
  final int categoryId;
  const LottoTabView3D({required this.categoryId, Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _LottoTabView3DState createState() => _LottoTabView3DState();
}

class _LottoTabView3DState extends ConsumerState<LottoTabView3D> {
